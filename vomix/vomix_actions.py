...
class vomix_actions:
    ...
    def createScript(self, module, module_obj):
        ...
        if module == "preprocess":
            ...
            script += 'snakemake --config module="viral-identify" ' + 'outdir="' + module_obj.outdir + '" datadir="' + module_obj.datadir + '" samplelist="' + module_obj.samplelist + '" --use-conda -j 4 --latency-wait 20'
            if module_obj.hasOptions:
                script += " --config"
