...
# this code was retrieved from https://github.com/EBI-Metagenomics/emg-viral-pipeline/blob/master/bin/contig_taxonomic_assign.py
# it has been modified to take an output file name instead of an output directory
...
def main(args):
	...
	with open(
		os.path.join(args.outpath), "w", newline=""
	) as output_file:
...
if __name__ == "__main__":
	...
	parser.add_argument(
		...
		"--input",
		dest="input_file",
		help="Annotation table generated with script viral_contig_annotate.py",
		required=True,
	)
	parser.add_argument(
		"-f",
	...
	parser.add_argument(
		...
		"--outpath",
		dest="outpath",
		help="Output file name with path to tsv file",
	)
