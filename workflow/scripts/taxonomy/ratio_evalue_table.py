...
# this script was directly retrieved https://github.com/EBI-Metagenomics/emg-viral-pipeline/blob/master/bin/ratio_evalue_table.py
...
if __name__ == "__main__":
	...
	parser.add_argument("-t", "--taxa", dest="taxa_tsv", help="TSV file: additional_data_vpHMMs_v{1,2,3,4}.tsv", required=True)
	parser.add_argument("-o", "--outfile", dest="out_file", help="Output table name (default: cwd)", default=".")
	parser.add_argument("-e", "--evalue", dest="evalue", help="E-value cutoff for each HMM hit", default=0.01)
