...
rule done_log:
  name: "community.py done. Removing tmp files"
  localrule: True
  input:
...
rule metaphlan:
  name: "community.py MetaPhlAn with Bowtie2"
  input: 
...
rule metaphlan_separate:
  name: "community.py separate MetaPhlAn outputs on taxonomy level"
  localrule: True
  input:
    relpath("community/metaphlan/output/metaphlan_out.txt")
  output:
