...
rule done_log:
  name: "prokaryote.smk Done. removing tmp files"
  localrule: True
  input:
    ...
    expand(relpath("binning/prokaryotic/assemblies/{assembly_id}/finalbin_DASTool_summary.tsv"), assembly_id=assembly_ids),
  output:
...
rule strobealign:
  name: "prokaryote.smk strobealign SR mapping"
  input:
...
rule indexbam:
  name: "prokaryote.smk index sorted BAM"
  localrule: True
  input:
...
rule binprep:
  name: "prokaryote.smk jgi summarize bam contig depths"
  input:
...
rule metabat2maxbin:
  name: "prokaryote.smk MetaBAT2 2 MaxBin2 coverage file"
  localrule: True
  input:
    relpath("binning/prokaryotic/assemblies/{assembly_id}/MetaBAT2/depthfile.txt")
  output:
...
rule metabat2:
  name: "prokaryote.smk MetaBAT2 binning"
  input:
...
rule maxbin2:
  name: "prokaryote.smk MaxBin2 binning"
  input:
...
rule concoctprep:
  name: "prokaryote.smk CONCOCT prepare"
  input:
...
rule concoct:
  name: "prokaryote.smk CONCOCT binning"
  input:
    fasta=relpath("assembly/samples/{assembly_id}/output/final.contigs.fa"),
    bed=relpath("binning/prokaryotic/assemblies/{assembly_id}/CONCOCT/final.contigs.10k.bed"),
    fa=relpath("binning/prokaryotic/assemblies/{assembly_id}/CONCOCT/final.contigs.10k.fa"),       
...
rule contigs2bin:
  name: "prokaryote.smk Generate contigs2bin tables"
  input:
...
rule dastool:
  name: "prokaryote.smk DAS Tool consensus binning"
  input:
    fasta=relpath("assembly/samples/{assembly_id}/output/final.contigs.fa"),
    MetaBAT2=relpath("binning/prokaryotic/assemblies/{assembly_id}/MetaBAT2/contigs2bin.tsv"),
    MaxBin2=relpath("binning/prokaryotic/assemblies/{assembly_id}/MaxBin2/contigs2bin.tsv"),
    CONCOCT=relpath("binning/prokaryotic/assemblies/{assembly_id}/CONCOCT/contigs2bin.tsv")
  output:
    relpath("binning/prokaryotic/assemblies/{assembly_id}/finalbin_DASTool_summary.tsv")
  params:
