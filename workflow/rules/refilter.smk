...
rule done_log:
  ...
  localrule: True
  input:
    expand(relpath("viralcontigident/samples/{sample_id}/output/viral.contigs.fa"), sample_id=assembly_ids), 
...
remove_files(expand(relpath("viralcontigident/samples/{sample_id}/output/viral.contigs.fa"), sample_id=assembly_ids))
remove_files([os.path.join(logdir, "done.log")])
remove_files([relpath("viralcontigident/intermediate/scores/combined.viralcontigs.fa")])
remove_files([relpath("viralcontigident/intermediate/scores/combined_viral_scores.csv")])
remove_files([relpath("viralcontigident/output/checkv/combined_classification_results.csv")])
remove_files([relpath("viralcontigident/output/combined.final.vOTUs.fa")])
remove_files([relpath("viralcontigident/intermediate/scores/combined_allcontigs_scores.csv")])
